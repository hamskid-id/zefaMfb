  ...
  return (
    <div
      ...
      className={
        ...
        pt-1 px-1 text-4xl rounded-lg fixed bottom-10 right-5 z-50 select-none flex flex-col items-center border border-[#006837] text-black transition-all duration-1000 bg-[#006837] backdrop-blur-xl cursor-pointer active:scale-75 active:duration-300
        `
    }
      onClick={handleTop}
    >
